      ...
      <main className="flex-grow">
        ...
        <section id="fitur" className="py-32 bg-white relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span className="text-[var(--color-primary)] font-bold tracking-[0.4em] text-sm mb-4 block uppercase opacity-60">{t("landing.pillarsSub")}</span>
            <h2 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-24 tracking-tighter uppercase">{t("landing.pillarsTitle")}</h2>
            
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
              {[
                { name: t("landing.pillar1"), icon: <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 21h18M3 10h18M5 10V7a2 2 0 012-2h10a2 2 0 012 2v3m-9-5V3m4 2V3M9 21v-4a1 1 0 011-1h4a1 1 0 011 1v4"/></svg>, color: "bg-emerald-50 text-emerald-600" },
                { name: t("landing.pillar2"), icon: <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A10.003 10.003 0 0012 3v8h8a9.988 9.988 0 01-5.112 8.741m-5.321-4.14a9.954 9.954 0 00-1.838-1.979m2.039-4.003l1.9-1.9a2 2 0 112.828 2.828L12 10"/></svg>, color: "bg-blue-50 text-blue-600" },
                { name: t("landing.pillar3"), icon: <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>, color: "bg-amber-50 text-amber-600" },
                { name: t("landing.pillar4"), icon: <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>, color: "bg-indigo-50 text-indigo-600" },
                { name: t("landing.pillar5"), icon: <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5"/></svg>, color: "bg-rose-50 text-rose-600" }
              ].map((item, i) => (
        ...
        <section id="harga" className="py-32 bg-[#f8f9f5] border-y border-gray-100 relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">             <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6 tracking-tight">{t("landing.priceTitle")}</h2>
             <p className="text-gray-500 mb-20 max-w-2xl mx-auto text-lg leading-relaxed">{t("landing.priceSubtitle")}</p>
             
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
                {[
                  { name: t("landing.pkgBasic"), price: t("landing.priceFree"), features: [t("landing.pkgBasicFeature1"), t("landing.pkgBasicFeature2"), t("landing.pkgBasicFeature3")] },
                  { name: t("landing.pkgPremium"), price: "Rp 150rb", features: [t("landing.pkgPremiumFeature1"), t("landing.pkgPremiumFeature2"), t("landing.pkgPremiumFeature3")], highlight: true },
                  { name: t("landing.pkgTravel"), price: t("landing.priceCustom"), features: [t("landing.pkgTravelFeature1"), t("landing.pkgTravelFeature2"), t("landing.pkgTravelFeature3")] },
                  { name: t("landing.pkgLansia"), price: "Rp 250rb", features: [t("landing.pkgLansiaFeature1"), t("landing.pkgLansiaFeature2"), t("landing.pkgLansiaFeature3")] }
                ].map((pkg, i) => (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-24">
              <div className="flex-1 space-y-10">
                <h2 className="text-4xl lg:text-6xl font-bold text-gray-900 tracking-tight leading-tight uppercase">{t("landing.whyTitle")}</h2>
                <div className="space-y-8">
                   {[
                     { t: t("landing.why1Title"), d: t("landing.why1Desc") },
                     { t: t("landing.why2Title"), d: t("landing.why2Desc") },
                     { t: t("landing.why3Title"), d: t("landing.why3Desc") }
                   ].map((item, i) => (
