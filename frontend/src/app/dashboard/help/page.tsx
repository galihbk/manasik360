    ...
    <div className="w-full space-y-12 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
         ...
         <div className="lg:col-span-2 space-y-8">
            <h3 className="text-xl font-bold text-gray-900">Pertanyaan Umum (FAQ)</h3>
            <div className="bg-white p-8 lg:p-10 rounded-[3rem] border border-gray-50 shadow-sm">
               <FAQItem 
                 question="Bagaimana cara mengaktifkan paket Premium VR?" 
                 answer="Anda dapat memasukkan kode voucher yang didapat dari biro travel di halaman 'Paket & Aktivasi', atau melakukan pembelian langsung melalui WhatsApp admin kami."
               />
               <FAQItem 
                 question="Apakah aplikasi ini bisa digunakan tanpa kacamata VR?" 
                 answer="Bisa. Anda tetap dapat menikmati simulasi dalam mode 360 derajat biasa melalui layar smartphone atau komputer Anda."
               />
               <FAQItem 
                 question="Sertifikat saya tidak bisa diunduh, apa solusinya?" 
                 answer="Pastikan semua modul di halaman 'Progress Modul' sudah berstatus 100%. Jika sudah namun tetap bermasalah, silakan hubungi tim IT kami."
               />
               <FAQItem 
                 question="Apakah data progres saya akan tersimpan jika ganti perangkat?" 
                 answer="Ya, semua progres Anda tersimpan secara cloud di akun Anda. Cukup login kembali dengan email yang sama di perangkat baru."
               />
            </div>
         </div>
         ...
         <div className="space-y-8">
            <h3 className="text-xl font-bold text-gray-900">Butuh Bantuan Lebih?</h3>
            <Card className="p-8 bg-[#064e3b] text-white border-none shadow-xl rounded-[3rem] space-y-6">
               <div className="space-y-2">
                  <h4 className="font-bold text-lg">Hubungi Tim Kami</h4>
                  <p className="text-emerald-100 text-xs leading-relaxed">
                     Tim support kami siap membantu Anda setiap hari (08:00 - 21:00 WIB).
                  </p>
               </div>
               ...
               <div className="space-y-3">
                  <a href="#" className="flex items-center gap-4 p-4 bg-white/10 rounded-2xl hover:bg-white/20 transition-all border border-white/10">
                     ...
                     <div>
                        <p className="text-[10px] font-bold text-emerald-300 uppercase tracking-widest">WhatsApp Support</p>
                        <p className="text-sm font-bold">+62 812-9000-360</p>
                     </div>
                  </a>
