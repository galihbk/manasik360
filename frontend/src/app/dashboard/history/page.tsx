  ...
  return (
    <div className="w-full space-y-12 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
         {[
           { label: "Total Sesi Belajar", val: "24 Sesi", color: "text-blue-600" },
           { label: "Waktu Simulasi", val: "5 Jam 12 Menit", color: "text-emerald-600" },
           { label: "Doa yang Dihafal", val: "12 Doa", color: "text-amber-600" },
         ].map((stat, i) => (
