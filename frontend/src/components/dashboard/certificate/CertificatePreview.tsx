       ...
       <div className="bg-white rounded-[2.9rem] p-8 lg:p-12 space-y-8 relative overflow-hidden">
          ...
          {!isUnlocked && (
             <div className="absolute inset-0 bg-white/60 backdrop-blur-md z-20 flex flex-col items-center justify-center text-center p-8">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-2">{t("cert.locked")}</h4>
                <p className="text-sm text-gray-500 max-w-xs">{t("cert.lockedDesc")}</p>
             </div>
          )}
          ...
          <div className="flex flex-col items-center text-center space-y-6">
             ...
             <div className="space-y-2">
                <h3 className="text-[10px] font-bold text-[var(--color-accent)] uppercase tracking-[0.4em]">{t("cert.title")}</h3>
             ...
             <p className="text-sm text-gray-500 max-w-lg leading-relaxed">
                {t("cert.completionDesc")}
             </p>

             <div className="grid grid-cols-2 gap-12 pt-8">
                <div className="text-center">
                   <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">{t("cert.issuedDateLabel")}</p>
                   <p className="text-sm font-bold text-gray-900">{issueDate}</p>
                </div>
                <div className="text-center">
                   <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">{t("cert.idLabel")}</p>
